...
import inventorySystem.supermarket.IReceipt;
import inventorySystem.supermarket.ISupermarket;
import inventorySystem.supermarket.Supermarket;
...
public class Customer implements ICustomer {
   ...
   * @throws SupermarketNotCreatedException a Supermarket instance should be created before it can
   * have any customer. If the supermarket is not instantiated before constructing an customer, this
