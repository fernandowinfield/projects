...
import edu.neu.ccs.cs5004.problem1.IInventory;
...
/**
 * Supermarket is a class representing a supermarket with the inventory and order processing
 * methods of it. This class should and can only be instantiated once and retrieved by
 */
public class Supermarket implements ISupermarket {
   ...
   * @throws SupermarketNotCreatedException the exception thrown when there
   *     is an attempt to get the only supermarket instance before it has been
   *     instantiated.
   */
   ...
   * @throws SupermarketCreatedAgainException the exception thrown when there
  ...
  /**
   * Helper method to remove age-restrictive products from the cart and record them
   * in the input list removedItems.
   *
  ...
  /**
   * Helper method to substitute out-of-stock products and remove un-substitutable
   * products from the cart and record them in the input list removedItems.
   *
   * @param cart cart from which age-restrictive products are removed.
  ...
  /**
   * Helper method to substitute one out-of-stock product, or remove it
   * from the cart and add it in the input list removedItems.
   *
