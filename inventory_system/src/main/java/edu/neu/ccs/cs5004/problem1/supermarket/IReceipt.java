...
/**
 * IReceipt is a class representing a supermarket receipt with its details:
 * the list of out-of-stock items that were removed, the list of age-restrictive
 * items that were removed, the list of successfully purchased items, and the total
 * price.
 */
public interface IReceipt {
  /**
   * Get the list of items removed from the customer's order because they are out of
   * stock during the order processing by the Supermarket.
   *
  ...
  /**
   * Get the list of items removed from the customer's order because the customer's
   * age disallows he/she from buying.
   *
